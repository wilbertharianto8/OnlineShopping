...
<link href="productsIndex.css" type="text/css" rel="stylesheet" />
</HEAD>
<BODY>
...
<div class="navbar">
        <ul class="nav">
            ...
            <li class="glow" ><a href="checkout.php"><i class="fas fa-power-off">  CheckOut</i></a></li>
        </ul>
    </div>
...
<a id="btnEmpty" href="productsIndex.php?action=empty">Empty Cart</a>
<?php
...
<?php		
    foreach ($_SESSION["cart_item"] as $item){
		...
		?>
				...
				<td style="text-align:center;"><a href="productsIndex.php?action=remove&code=<?php echo $item["code"]; ?>" class="btnRemoveAction"><img src="icon-delete.png" alt="Remove Item" /></a></td>
				</tr>
				<?php
